# Contributing to the Centrify REST API Guidelines
The Centrify REST API Guidelines is a Centrify-wide initiative to develop consistent design guidelines for REST APIs. The initiative requires input and feedback from a variety of individuals both inside and outside of Centrify.
...
- Reference the version of the Centrify REST API Guidelines you are using.
...
This is the repository for Centrify REST API Guidelines documentation only. Please ensure that you are opening issues in the right repository.
...
[code-of-conduct]: https://opensource.centrify.com/codeofconduct/
[new-issue]: https://github.com/Centrify/api-guidelines/issues/new
[issue-search]: https://github.com/Centrify/api-guidelines/issues
